...
🌍 9+ years across **Fintech, SaaS, Blockchain, Mobile Apps, Real-time Systems, and Cloud Engineering**  
...
#### 🎨 Frontend & Mobile
React, Angular, Vue, Next.js, TypeScript, Tailwind, Material UI, Chakra UI, AntD, React Native, Flutter, State Management (Redux, Zustand)
...
#### 🔗 Blockchain & Web3
Web3.js, Ethers.js, Solidity, Smart Contracts, Wallet Integration, NFT/DeFi Systems
...
💬 Open to collaborations in **Fintech, AI, Blockchain, and Mobile Engineering**  
📩 Reach out — **consulting, architecture, mentoring, or open-source**

---

### 🔗 Blockchain & Web3 Involvement

- Integrated DApps using **Ethers.js / Web3.js**
- Wallet authentication: **MetaMask, WalletConnect**
- Smart Contract collaboration (**Solidity, ERC standards**)
- NFT minting & blockchain event handling
